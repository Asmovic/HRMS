<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="ReportOptLeaveRoaster.aspx.cs" Inherits="hrpages_ReportOptLeaveRoaster" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <div>
        ...
        <h4>Leave Roaster Report Option</h4>
        
    <div class="form-group">
            <asp:Label runat="server"  CssClass="col-md-4 control-label">Choose Option</asp:Label>
            <div class="col-md-8">
