<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="LeaveAppr.aspx.cs" Inherits="hrpages_LeaveAppr" %>
...
<div class="col-md-6">
   ...
   <div class="form-group">
     ...
     <div class="form-group">
            ...
            <div class="col-md-8">
                <asp:TextBox ID="txtlyear" Enabled="false" runat="server" CssClass="form-control" OnTextChanged="txtlyear_TextChanged"  ></asp:TextBox>
        ...
        <div class="form-group">
            ...
            <div class="col-md-8">
                <asp:DropDownList ID="cmbloc" Enabled="false" runat="server" CssClass="form-control" AutoPostBack="true"  OnSelectedIndexChanged="cmbloc_SelectedIndexChanged"></asp:DropDownList>
            ...
            <div class="col-md-8">
                <asp:DropDownList ID="cmbdept" Enabled="false" runat="server" CssClass="form-control" AutoPostBack="true"  OnSelectedIndexChanged="cmbdept_SelectedIndexChanged"></asp:DropDownList>
...
<div class="col-md-6">
    ...
    <br />
           ...
           <div class="col-md-8">
                 <asp:UpdatePanel runat="server">
                    <ContentTemplate>
                <asp:RadioButton runat ="server"  ID="txtyc" Text="Yes" AutoPostBack="true" OnCheckedChanged="txtyc_CheckedChanged"></asp:RadioButton>
                <asp:RadioButton runat ="server"  ID="txtnc" Text="No" AutoPostBack="true" OnCheckedChanged="txtnc_CheckedChanged"></asp:RadioButton>  
                  </ContentTemplate>
                    </asp:UpdatePanel> 
    </div>
      </div>
    ...
    <div class="form-group" >
            ...
            <div class="col-md-8">
                <asp:TextBox ID="txtstid" Enabled="false" runat="server" AutoPostBack="true" OnTextChanged="txtstid_TextChanged" CssClass="form-control" ></asp:TextBox>
    ...
    <div class="form-group">
         ...
         <div class="form-group">
            ...
            <div class="col-md-8">
                <asp:TextBox ID="txtstart" Enabled="false" runat="server" AutoPostBack="true" CssClass="form-control" MaxLength="15" OnTextChanged="txtstart_TextChanged1" ></asp:TextBox>
    ...
    <div class="form-group">
       ...
       <div class="form-group">
        ...
        <div class="form-group">
            ...
            <div class="col-md-8">
                <asp:TextBox ID="txtend" Enabled="false" AutoPostBack="true" runat="server" CssClass="form-control" MaxLength="15" ></asp:TextBox>
              <br />
            </div>
             </div>
                     <br />
