<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" MaintainScrollPositionOnPostback="true" CodeFile="LeaveType.aspx.cs" Inherits="hrpages_LeaveType" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <div>
        ...
        <h4>Leave Type Setup</h4>
        
    <div class="form-group">
            <asp:Label runat="server"  CssClass="col-md-4 control-label">Leave Type Code</asp:Label>
            <div class="col-md-8">
    ...
    <div class="form-group">
            <asp:Label runat="server" CssClass="col-md-4 control-label">Leave Type Name</asp:Label>
            <div class="col-md-8">
      ...
      <div class="form-group">
            <asp:Label runat="server" CssClass="col-md-4 control-label">Deductable</asp:Label>
            <div class="col-md-8">
                
                <asp:RadioButton ID="chno" Text="Non Deductable" runat="server" AutoPostBack="true" OnCheckedChanged="chno_CheckedChanged" />
                <asp:RadioButton runat="server" ID="chyes" Text="Deductable" AutoPostBack="true"  OnCheckedChanged="chyes_CheckedChanged" /> 
