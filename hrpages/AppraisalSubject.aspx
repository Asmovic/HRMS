<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" MaintainScrollPositionOnPostback="true" CodeFile="AppraisalSubject.aspx.cs" Inherits="hrpages_AppraisalSubject" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <div>
        ...
        <h4>Appraisal Subject Setup</h4>


        
    <div class="form-group">
            <asp:Label runat="server"  CssClass="col-md-4 control-label">Appraisal Subject Code </asp:Label>
            <div class="col-md-8">
    ...
    <div class="form-group">
            <asp:Label runat="server" CssClass="col-md-4 control-label">Appraisal Subject Name</asp:Label>
            <div class="col-md-8">
         ...
         <div class="form-group">
            <asp:Label runat="server"  CssClass="col-md-4 control-label">S No: </asp:Label>
            <div class="col-md-8">
                <asp:TextBox ID="txtsno" Enabled="false" runat="server" CssClass="form-control" MaxLength="5" AutoPostBack="true" OnTextChanged="txtsno_TextChanged"></asp:TextBox>
   ...
   <p style="color:hotpink;"> Today's Date is: <span id="alert"></span></p>
    <script>
        var d =new Date();
        document.getElementById("alert").innerHTML = d.toUTCString();
    </script>
