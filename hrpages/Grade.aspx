<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="Grade.aspx.cs" MaintainScrollPositionOnPostback="true" Inherits="hrpages_Grade" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <div>
        ...
        <h4>Grade Level Setup</h4>
        
    <div class="form-group">
            <asp:Label runat="server"  CssClass="col-md-4 control-label">Grade Code</asp:Label>
            <div class="col-md-8">
    ...
    <div class="form-group">
            <asp:Label runat="server" CssClass="col-md-4 control-label">Grade Name</asp:Label>
            <div class="col-md-8">
      ...
      <div class="form-group">
            <asp:Label runat="server" CssClass="col-md-4 control-label">Leave Days</asp:Label>
            <div class="col-md-8">
                <asp:TextBox ID="TxtLeave" runat="server" CssClass="form-control" MaxLength="20"></asp:TextBox>
                <asp:RequiredFieldValidator runat="server" ControlToValidate="TxtLeave" CssClass="text-danger" ErrorMessage="This field is required." />
            </div>
             </div>
