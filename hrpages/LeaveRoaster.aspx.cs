...
public partial class hrpages_LeaveRoaster : System.Web.UI.Page
{
    ...
    protected void txtlrefno_TextChanged(object sender, EventArgs e)
    {
     ...
     //   txtsno.Text = RetrieveFields.retrieveByFieldIndex_HasOneKey(2, AppTables.StLeaveHead_Tab, AppFields.Stleavehead_Fld1a, txtlrefno.Text, "string");
      ...
      //  txtsno.Text = (int.Parse(gridview2.Rows[gridview2.Rows.Count - 1].Cells[1].Text) + 1).ToString();
        txtsno.Text = SaveRecord.Retrieve_Details(txtlrefno.Text, gridview2);
    }
    ...
    protected void submitButton_Click(object sender, EventArgs e)
    {
        ...
        txtsno.Text = SaveRecord.Count_leave_Detail(txtlrefno.Text);
   ...
   //   txtsno.Text = (int.Parse(gridview2.Rows[gridview2.Rows.Count -1].Cells[1].Text) + 1).ToString();
    ...
    protected void gridview2_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        txtsno.Text = msno;
        //txtlyear.Text= RetrieveFields.retrieveByFieldIndex_HasTwoKeys(1, AppTables.StLeaveHead_Tab, AppFields.Stleavehead_Fld1a, txtlrefno.Text, AppFields.Emphis_Fld1a, mystid, "string");
        //gloc2 = RetrieveFields.retrieveByFieldIndex_HasTwoKeys(3, AppTables.StLeaveHead_Tab, AppFields.Stleavehead_Fld1a, txtlrefno.Text, AppFields.Emphis_Fld1a, mystid, "string");
        //cmbloc.SelectedItem.Text = RetrieveFields.retrieveByFieldIndex_HasOneKey(1, AppTables.Loc_Tab, AppFields.Loc_Fld1a, gloc2, "string");
        //gdept2 = RetrieveFields.retrieveByFieldIndex_HasTwoKeys(4, AppTables.StLeaveDettemp_Tab, AppFields.Stleavehead_Fld1a, txtlrefno.Text, AppFields.Emphis_Fld1a, mystid, "string");
        //cmbdept.SelectedItem.Text = RetrieveFields.retrieveByFieldIndex_HasOneKey(1, AppTables.Dept_Tab, AppFields.Dept_Fld1a, gdept2, "string");
