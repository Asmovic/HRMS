<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="TrainingNominationRoasterAppr.aspx.cs" Inherits="hrpages_TrainingNominationRoasterAppr" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <div class="header">
        ...
        <h3>Training Nomination Approval</h3>
    </div>
...
<div class="col-md-6">
    ...
    <br />
     ...
     <div class="form-group">
            ...
            <div class="col-md-8">
                <asp:TextBox ID="txtstid" runat="server" Enabled="false" CssClass="form-control" MaxLength="15" AutoPostBack="true" OnTextChanged="txtstid_TextChanged"></asp:TextBox>
  ...
  <div class="form-group">
    ...
    <div class="form-group">
     ...
     <div class="form-group">
            ...
            <div class="col-md-8">
                <asp:TextBox ID="traindate" runat="server" Enabled="false" CssClass="form-control" ></asp:TextBox>
     ...
     <div class="form-group">
            ...
            <div class="col-md-8">
                <asp:TextBox ID="traindur" runat="server" Enabled="false" CssClass="form-control" ></asp:TextBox>
     ...
     <div class="form-group">
            ...
            <div class="col-md-8">
                <asp:TextBox ID="orgname" runat="server" Enabled="false" CssClass="form-control" ></asp:TextBox>
     ...
     <div class="form-group">
            ...
            <div class="col-md-8">
                <asp:TextBox ID="orgadd" runat="server" Enabled="false" CssClass="form-control" ></asp:TextBox>
