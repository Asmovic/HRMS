...
public partial class hrpages_TransferRoaster : System.Web.UI.Page
{
    ...
    protected void txttrefno_TextChanged(object sender, EventArgs e)
    {
        ...
        txtsno.Text = SaveRecord.Retrieve_Detailt(txttrefno.Text, gridview2);
    ...
    protected void submitButton_Click(object sender, EventArgs e)
    {
        ...
        txtsno.Text = SaveRecord.Count_transfer_Detail(txttrefno.Text);
...
protected void txtstid_TextChanged(object sender, EventArgs e)
{
    ...
    //SaveRecord.Retrieve_Detailt(txttrefno.Text, gridview2);
    txtsno.Text = SaveRecord.Retrieve_Detailt(txttrefno.Text, gridview2);
}
