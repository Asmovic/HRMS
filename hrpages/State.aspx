<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="State.aspx.cs" Inherits="hrpages_State" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <div class="form-group">
            <asp:Label runat="server" CssClass="col-md-4 control-label">State Name</asp:Label>
            <div class="col-md-8">
