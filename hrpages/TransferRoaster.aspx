<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="TransferRoaster.aspx.cs" Inherits="hrpages_TransferRoaster" %>
...
<div class="col-md-6">
     ...
     <div class="form-group">
            <asp:Label runat="server" Visible="false" CssClass="col-md-4 control-label">Remark</asp:Label>
            <div class="col-md-8">
                <asp:TextBox ID="txtremark" Enabled="false" Visible="false" TextMode="MultiLine" runat="server" CssClass="form-control"  ></asp:TextBox>
