<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="PFA.aspx.cs" Inherits="hrpages_PFA" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <div class="form-group">
            <asp:Label runat="server" Font-Bold="true" CssClass="col-md-4 control-label">PFA Code</asp:Label>
            <div class="col-md-8">
    ...
    <div class="form-group">
            <asp:Label runat="server" Font-Bold="true" CssClass="col-md-4 control-label">PFA No</asp:Label>
            <div class="col-md-8">
