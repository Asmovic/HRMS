<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="TrainingTransactionAppr.aspx.cs" Inherits="hrpages_TrainingTransactionAppr" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <div class="header">
        ...
        <h3>Training Transaction Approval</h3>
    </div>
...
<div class="col-md-6">
    ...
    <br />
     ...
     <div class="form-group">
            ...
            <div class="col-md-8">
                <asp:TextBox ID="txtstid" Enabled="false" runat="server" CssClass="form-control" MaxLength="3" AutoPostBack="true" OnTextChanged="txtstid_TextChanged"></asp:TextBox>
    ...
    <div class="form-group">
            ...
            <div class="col-md-8">
                ...
                <asp:RadioButton ID="intt" Text="Inservice Training" Enabled="false" runat="server" AutoPostBack="true" OnCheckedChanged="intt_CheckedChanged" />
                <asp:RadioButton runat="server" ID="extt" Text="External Training" Enabled="false" AutoPostBack="true"  OnCheckedChanged="extt_CheckedChanged" /> 
    ...
    <div class="form-group">
            ...
            <div class="col-md-8">
               <asp:DropDownList  ID="cmbname" Enabled="false" runat="server" CssClass="form-control" OnSelectedIndexChanged="cmbname_SelectedIndexChanged"></asp:DropDownList>
     ...
     <div class="form-group">
            ...
            <div class="col-md-8">
                <asp:TextBox ID="traindate" Enabled="false" runat="server" CssClass="form-control"  ></asp:TextBox>
     ...
     <div class="form-group">
            ...
            <div class="col-md-8">
                <asp:TextBox ID="traindur" Enabled="false" runat="server" CssClass="form-control" ></asp:TextBox>
     ...
     <div class="form-group">
            ...
            <div class="col-md-8">
                <asp:TextBox ID="trainins" Enabled="false" runat="server" CssClass="form-control" ></asp:TextBox>
     ...
     <div class="form-group">
            ...
            <div class="col-md-8">
                <asp:TextBox ID="certob" runat="server" Enabled="false" CssClass="form-control" ></asp:TextBox>
