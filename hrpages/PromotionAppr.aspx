<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="PromotionAppr.aspx.cs" Inherits="hrpages_PromotionAppr" %>
...
<div class="col-md-6">
   ...
   <div class="form-group">
     ...
     <div class="form-group">
            ...
            <div class="col-md-8">
                <asp:TextBox ID="txtpyear" Enabled="false" runat="server" CssClass="form-control" OnTextChanged="txtpyear_TextChanged"  ></asp:TextBox>
         ...
         <div class="form-group">
            <asp:Label runat="server"  CssClass="col-md-4 control-label">Checked By:</asp:Label>
            <div class="col-md-8">
          ...
          <div class="form-group">
            ...
            <div class="col-md-8">
                <asp:TextBox ID="txtchkd" Enabled="false" runat="server" CssClass="form-control"  ></asp:TextBox>
...
<div class="col-md-6">
         ...
         <div class="form-group">
          ...
          <div class="form-group">
            <asp:Label runat="server" ID="lblapprd"  CssClass="col-md-4 control-label">Approved Date</asp:Label>
            <div class="col-md-8">
     ...
     <div class="form-group">
            <asp:Label runat="server" ID="lblrem"  CssClass="col-md-4 control-label">Remark</asp:Label>
            <div class="col-md-8">
          ...
          <div class="form-group">
            <asp:Label runat="server" ID="lblappr"  CssClass="col-md-4 control-label">Approved ?( YES / NO )</asp:Label>
           <div class="col-md-8">
                 <asp:UpdatePanel runat="server">
                    <ContentTemplate>
    ...
    <div class="form-group">
            ...
            <div class="col-md-8">
                <asp:TextBox ID="txtngrade" Enabled="false" runat="server" CssClass ="form-control"  ></asp:TextBox>
       ...
       <div class="form-group">
            ...
            <div class="col-md-8">
                <asp:TextBox ID="txtnstep" Enabled="false" runat="server" CssClass ="form-control" ></asp:TextBox>
       ...
       <div class="form-group">
            ...
            <div class="col-md-8">
                <asp:TextBox ID="txtpdate" Enabled="false" runat="server" CssClass ="form-control"></asp:TextBox>
