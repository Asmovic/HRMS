<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="LGA_Origin.aspx.cs" Inherits="hrpages_LGA_Origin" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <div>
        ...
        <h4>Local Government of Origin Setup</h4>
        
    <div class="form-group">
            <asp:Label runat="server" CssClass="col-md-4 control-label">State Code</asp:Label>
            <div class="col-md-8">
                <asp:DropDownList runat ="server" CssClass="form-control" ID="cmbstate" AutoPostBack ="true" OnSelectedIndexChanged="cmbstate_SelectedIndexChanged"></asp:DropDownList>
    ...
    <div class="form-group">
            <asp:Label runat="server" CssClass="col-md-4 control-label">LGA Code</asp:Label>
            <div class="col-md-8">
    ...
    <div class="form-group">
            <asp:Label runat="server" CssClass="col-md-4 control-label">LGA Name</asp:Label>
            <div class="col-md-8">
                <asp:TextBox ID="TxtName" runat="server" CssClass="form-control" MaxLength="20" OnTextChanged="TxtName_TextChanged"></asp:TextBox>
